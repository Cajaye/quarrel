    ...
    return (
        <form onSubmit={submit} className="bg-white rounded-md px-6 py-2 mt-12 mb-6" method="post">
            <div className="my-2">
                ...
                <input className="bg-gray-200 my-3 w-full px-6 py-2 rounded-md" value={title} placeholder="What's on your mind?" type="text" name="title" onChange={(e) => setTitle(e.target.value)} />
            </div>
